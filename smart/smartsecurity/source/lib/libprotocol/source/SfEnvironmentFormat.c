                                             ...
                                             Int32 result )
{
    ...
    {
        SF_LOG_E( "takes invalid argument (pEnvironment = %p), pProcessContext = %p",
                  pEnvironment, pProcessContext );
                                        ...
                                        const SfOperationFileOpen* pArgs )
{
    ...
    {
        SF_LOG_E( "takes invalid argument (pEnvironment = %p), pArgs = %p", 
                  pEnvironment, pArgs );
        return SF_STATUS_BAD_ARG;
    }
                                        ...
                                        const SfOperationFileMmap* pArgs )
{
    ...
    if ( !pEnvironment || !pArgs )
    {
        SF_LOG_E( "invalid arguments pEnvironment = %p, pArgs = %p", 
                  pEnvironment, pArgs );
        return SF_STATUS_BAD_ARG;
    }
    ...
    if ( pHeader )
    {
        switch ( pHeader->type )
        {
            ...
            case SF_ENVIRONMENT_TYPE_SND_RCV:
                SfDestroySndRcvEnvironment( (SfSndRcvEnvironment*)pHeader );
                break;
            default:
                break;
        }
